...
const useStyles = makeStyles((theme) => ({
  ...
  repoButton: {
    ...
    padding: '6px 16px',
    marginBottom: '2rem', // مسافة بين الزرار ونهاية البلوك
    '&:hover': {
  ...
  const [projects] = useState([
    {
      ...
      alter: 'LoFo Project',
      image: `${Lofo}`,
      repoUrl: 'https://github.com/MoazRyhan/luckybank-back-sequelize',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      image: `${Veritru}`,
      repoUrl: 'https://github.com/MoazRyhan/BlogApp-back-mySQL2',
    },
    {
      id: 4,
      title: 'Saraha App',
      ...
      image: `${Portfolio}`,
      repoUrl: 'https://github.com/MoazRyhan/SarahaApp-back-NoSql',
    },
    {
      id: 5,
      ...
      alter: 'Startup Project',
      image: `${Startup}`,
      repoUrl: 'https://moazryhan.github.io/FreshCart-front-react/',
    },
  ]);
        ...
        {projects.map((project, index) => (
          <div className="project" key={project.id}>
            <motion.div
              ...
              initial={{ x: 100, opacity: 0 }} // من اليمين
            ...
            <motion.div
              ...
              initial={{ x: -100, opacity: 0 }} // من الشمال
              whileInView={{ x: 0, opacity: 1 }}
              transition={{ duration: 0.7, delay: index * 0.2 }}
              viewport={{ once: true, amount: 0.3 }}
            >
